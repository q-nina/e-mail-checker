...
**Try this sample input in the app:**

```
support-in@google.com, simple@example.com, user@outlook.com, john.doe@gmail.com, user@unknown-xxx.com, invalid..email@example.com, ., 
```
...
* **email_check_and_validate** – providing:

  * `validate_email_syntax(email)`
  * `check_mx_records(domain)`
  * `check_smtp_recipient(email)`
